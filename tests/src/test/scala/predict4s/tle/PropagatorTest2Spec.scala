...
//    assert(vz == 4.534807249)
    ...
    val state0 = SGP4TimeIndependentFunctions[Double](TEME.sgpElems[Double](tle))
...
//    val initialState = new SGP4TimeIndependentFunctions[Double](InitialTleValues(tle), WGS72Constants.tleDoubleConstants)
//    val ti = new SGP4TimeIndependentFunctions[Double](initialState)

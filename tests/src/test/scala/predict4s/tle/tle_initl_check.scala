...
//checkSgp4Init9880(s9880)
//checkSgp4Init9998(s9998)
//checkSgp4Init11801(s11801)
//checkSgp4Init14128(s14128)
//checkSgp4Init16925(s16925)
//checkSgp4Init20413(s20413)
//checkSgp4Init21897(s21897)
//checkSgp4Init22312(s22312)
//checkSgp4Init22674(s22674)
//checkSgp4Init23177(s23177)
//checkSgp4Init23333(s23333)
//checkSgp4Init23599(s23599)
//checkSgp4Init24208(s24208)
//checkSgp4Init25954(s25954)
//checkSgp4Init26900(s26900)
//checkSgp4Init26975(s26975)
checkSgp4Init28057(s28057)
//checkSgp4Init28129(s28129)
//checkSgp4Init28350(s28350)
//checkSgp4Init28623(s28623)
//checkSgp4Init28626(s28626)
//checkSgp4Init28872(s28872)
...
// 5
                                   // ------------------after initl  :---------------
def checkIntl4632(ini : Initl) {
 import ini._
  assert(   satn  ===            4632 );  assert(   ecco  ===     0.145050600 );  assert(  epoch  === 19754.910709590 );  assert(  inclo  ===     0.200063601 ); 
 //   in/out : 
  assert(     no  ===     0.005245869 ); 
 //   outputs : 
    assert(   ainv  ===     0.170722893 ); assert(     ao  ===     5.857445274 ); assert(  con41  ===     1.881517177 ); assert(  con42  ===    -3.802528628 ); assert(  cosio  ===     0.980053940 ); 
...
/*  assert(  einx   ===     0.021039677 ); */ assert(  eccsq  ===     0.021039677 ); assert(  omeosq ===     0.978960323 ); assert(   posq  ===    32.881124410 ); assert(     rp  ===     5.007819322 ); assert(  rteosq ===     0.989424238 ); 
  assert(  sinio  ===     0.198731664 ); assert(   gsto  ===     1.716027084 ); 
       ...
       // ------------------after sgp4init :-------------
def checkSgp4Init4632(ini: Sgp4Init) = {
 import ini._
...
//    outputs  :
assert(  isimp  ===               1); 
assert( method  ===               'd'); assert(  aycof  ===     0.000232797 ); 
...
def checkIntl6251(ini : Initl) {
 import ini._
  assert(   satn  ===            6251 );  assert(   ecco  ===     0.003003500 );  assert(  epoch  === 20630.824120140 );  assert(  inclo  ===     1.013301512 ); 
 //   in/out : 
  assert(     no  ===     0.067918037 ); 
 //   outputs : 
    assert(   ainv  ===     0.941319167 ); assert(     ao  ===     1.062338933 ); assert(  con41  ===    -0.160280193 ); assert(  con42  ===    -0.399533012 ); assert(  cosio  ===     0.529062002 ); 
...
// 6251
                                   // ------------------after initl  :---------------
def checkIntl8195(ini : Initl) {
 import ini._
  assert(   satn  ===            8195 );  assert(   ecco  ===     0.687714600 );  assert(  epoch  === 20630.332154440 );  assert(  inclo  ===     1.119778813 ); 
 //   in/out : 
  assert(     no  ===     0.008748547 ); 
 //   outputs : 
    assert(   ainv  ===     0.240088176 ); assert(     ao  ===     4.165136398 ); assert(  con41  ===    -0.430021887 ); assert(  con42  ===     0.050036478 ); assert(  cosio  ===     0.435881526 ); 
...
/*  assert(  einx   ===     0.472951371 ); */ assert(  eccsq  ===     0.472951371 ); assert(  omeosq ===     0.527048629 ); assert(   posq  ===     4.819032242 ); assert(     rp  ===     1.300711286 ); assert(  rteosq ===     0.725981149 ); 
  assert(  sinio  ===     0.900004053 ); assert(   gsto  ===     0.574180127 ); 
       ...
       // ------------------after sgp4init :-------------
def checkSgp4Init8195(ini: Sgp4Init) = {
 import ini._
...
assert(     no  ===     0.008748547 ); 
//    outputs  :
 assert(  isimp  ===               1); assert( method  ===               'd'); assert(  aycof  ===     0.001055442 ); 
...
// 8195
                                   // ------------------after initl  :---------------
def checkIntl9880(ini : Initl) {
 import ini._
  assert(   satn  ===            9880 );  assert(   ecco  ===     0.706905100 );  assert(  epoch  === 20630.561574750 );  assert(  inclo  ===     1.127426846 ); 
 //   in/out : 
  assert(     no  ===     0.008762667 ); 
 //   outputs : 
    assert(   ainv  ===     0.240346439 ); assert(     ao  ===     4.160660767 ); assert(  con41  ===    -0.447914105 ); assert(  con42  ===     0.079856841 ); assert(  cosio  ===     0.428985584 ); 
...
/*  assert(  einx   ===     0.499714820 ); */ assert(  eccsq  ===     0.499714820 ); assert(  omeosq ===     0.500285180 ); assert(   posq  ===     4.332712684 ); assert(     rp  ===     1.219468451 ); assert(  rteosq ===     0.707308405 ); 
  assert(  sinio  ===     0.903311335 ); assert(   gsto  ===     2.019617117 ); 
       ...
       // ------------------after sgp4init :-------------
def checkSgp4Init9880(ini: Sgp4Init) = {
 import ini._
...
assert(     no  ===     0.008762667 ); 
//    outputs  :
 assert(  isimp  ===               1); assert( method  ===               'd'); assert(  aycof  ===     0.001059043 ); 
...
// 9880
                                   // ------------------after initl  :---------------
def checkIntl9998(ini : Initl) {
 import ini._
  assert(   satn  ===            9998 );  assert(   ecco  ===     0.027097100 );  assert(  epoch  === 20237.794179280 );  assert(  inclo  ===     0.165732975 ); 
 //   in/out : 
  assert(     no  ===     0.005069385 ); 
 //   outputs : 
    assert(   ainv  ===     0.166872070 ); assert(     ao  ===     5.992614588 ); assert(  con41  ===     1.918349444 ); assert(  con42  ===    -3.863915741 ); assert(  cosio  ===     0.986297698 ); 
...
/*  assert(  einx   ===     0.000734253 ); */ assert(  eccsq  ===     0.000734253 ); assert(  omeosq ===     0.999265747 ); assert(   posq  ===    35.858712827 ); assert(     rp  ===     5.830232111 ); assert(  rteosq ===     0.999632806 ); 
  assert(  sinio  ===     0.164975307 ); assert(   gsto  ===     3.007604047 ); 
       ...
       // ------------------after sgp4init :-------------
def checkSgp4Init9998(ini: Sgp4Init) = {
 import ini._
...
assert(     no  ===     0.005069385 ); 
//    outputs  :
 assert(  isimp  ===               1); assert( method  ===               'd'); assert(  aycof  ===     0.000193694 ); 
...
// 9998
                                   // ------------------after initl  :---------------
def checkIntl11801(ini : Initl) {
 import ini._
  assert(   satn  ===           11801 );  assert(   ecco  ===     0.731803600 );  assert(  epoch  === 11187.296297880 );  assert(  inclo  ===     0.816667482 ); 
 //   in/out : 
  assert(     no  ===     0.009971132 ); 
 //   outputs : 
    assert(   ainv  ===     0.261964907 ); assert(     ao  ===     3.817305189 ); assert(  con41  ===     0.406253180 ); assert(  con42  ===    -1.343755300 ); assert(  cosio  ===     0.684653971 ); 
...
/*  assert(  einx   ===     0.535536509 ); */ assert(  eccsq  ===     0.535536509 ); assert(  omeosq ===     0.464463491 ); assert(   posq  ===     3.143525080 ); assert(     rp  ===     1.023787510 ); assert(  rteosq ===     0.681515584 ); 
  assert(  sinio  ===     0.728868260 ); assert(   gsto  ===     1.265125076 ); 
       ...
       // ------------------after sgp4init :-------------
def checkSgp4Init11801(ini: Sgp4Init) = {
 import ini._
...
assert(     no  ===     0.009971132 ); 
//    outputs  :
 assert(  isimp  ===               1); assert( method  ===               'd'); assert(  aycof  ===     0.000854057 ); 
...
// 11801
                                   // ------------------after initl  :---------------
def checkIntl14128(ini : Initl) {
 import ini._
  assert(   satn  ===           14128 );  assert(   ecco  ===     0.001156200 );  assert(  epoch  === 20630.028448930 );  assert(  inclo  ===     0.199637741 ); 
 //   in/out : 
  assert(     no  ===     0.004313875 ); 
 //   outputs : 
    assert(   ainv  ===     0.149850601 ); assert(     ao  ===     6.673313224 ); assert(  con41  ===     1.882014339 ); assert(  con42  ===    -3.803357232 ); assert(  cosio  ===     0.980138483 ); 
...
/*  assert(  einx   ===     0.000001337 ); */ assert(  eccsq  ===     0.000001337 ); assert(  omeosq ===     0.999998663 ); assert(   posq  ===    44.532990320 ); assert(     rp  ===     6.665597539 ); assert(  rteosq ===     0.999999332 ); 
  assert(  sinio  ===     0.198314280 ); assert(   gsto  ===     4.943902852 ); 
       ...
       // ------------------after sgp4init :-------------
def checkSgp4Init14128(ini: Sgp4Init) = {
 import ini._
...
assert(     no  ===     0.004313875 ); 
//    outputs  :
 assert(  isimp  ===               1); assert( method  ===               'd'); assert(  aycof  ===     0.000232900 ); 
...
// 14128
                                   // ------------------after initl  :---------------
def checkIntl16925(ini : Initl) {
 import ini._
  assert(   satn  ===           16925 );  assert(   ecco  ===     0.559632700 );  assert(  epoch  === 20605.674157710 );  assert(  inclo  ===     1.083685405 ); 
 //   in/out : 
  assert(     no  ===     0.021317321 ); 
 //   outputs : 
    assert(   ainv  ===     0.434745641 ); assert(     ao  ===     2.300195578 ); assert(  con41  ===    -0.342717947 ); assert(  con42  ===    -0.095470089 ); assert(  cosio  ===     0.468074799 ); 
...
/*  assert(  einx   ===     0.313188759 ); */ assert(  eccsq  ===     0.313188759 ); assert(  omeosq ===     0.686811241 ); assert(   posq  ===     2.495768608 ); assert(     rp  ===     1.012930916 ); assert(  rteosq ===     0.828740756 ); 
  assert(  sinio  ===     0.883688849 ); assert(   gsto  ===     2.298863661 ); 
       ...
       // ------------------after sgp4init :-------------
def checkSgp4Init16925(ini: Sgp4Init) = {
 import ini._
...
assert(     no  ===     0.021317321 ); 
//    outputs  :
 assert(  isimp  ===               1); assert( method  ===               'd'); assert(  aycof  ===     0.001036141 ); 
...
// 16925
                                   // ------------------after initl  :---------------
def checkIntl20413(ini : Initl) {
 import ini._
  assert(   satn  ===           20413 );  assert(   ecco  ===     0.786444700 );  assert(  epoch  === 20452.791666670 );  assert(  inclo  ===     0.215572597 ); 
 //   in/out : 
  assert(     no  ===     0.001077284 ); 
 //   outputs : 
    assert(   ainv  ===     0.059424681 ); assert(     ao  ===    16.828024612 ); assert(  con41  ===     1.862731633 ); assert(  con42  ===    -3.771219389 ); assert(  cosio  ===     0.976854072 ); 
...
/*  assert(  einx   ===     0.618495266 ); */ assert(  eccsq  ===     0.618495266 ); assert(  omeosq ===     0.381504734 ); assert(   posq  ===    41.216028293 ); assert(     rp  ===     3.593713844 ); assert(  rteosq ===     0.617660695 ); 
  assert(  sinio  ===     0.213906807 ); assert(   gsto  ===     0.407188564 ); 
       ...
       // ------------------after sgp4init :-------------
def checkSgp4Init20413(ini: Sgp4Init) = {
 import ini._
...
assert(     no  ===     0.001077284 ); 
//    outputs  :
 assert(  isimp  ===               1); assert( method  ===               'd'); assert(  aycof  ===     0.000234252 ); 
...
// 20413
                                   // ------------------after initl  :---------------
def checkIntl21897(ini : Initl) {
 import ini._
  assert(   satn  ===           21897 );  assert(   ecco  ===     0.742169000 );  assert(  epoch  === 20630.023412440 );  assert(  inclo  ===     1.085156717 ); 
 //   in/out : 
  assert(     no  ===     0.008782536 ); 
 //   outputs : 
    assert(   ainv  ===     0.240709610 ); assert(     ao  ===     4.154383373 ); assert(  con41  ===    -0.346365789 ); assert(  con42  ===    -0.089390352 ); assert(  cosio  ===     0.466774111 ); 
...
/*  assert(  einx   ===     0.550814825 ); */ assert(  eccsq  ===     0.550814825 ); assert(  omeosq ===     0.449185175 ); assert(   posq  ===     3.482282274 ); assert(     rp  ===     1.071128819 ); assert(  rteosq ===     0.670212784 ); 
  assert(  sinio  ===     0.884376577 ); assert(   gsto  ===     4.912171010 ); 
       ...
       // ------------------after sgp4init :-------------
def checkSgp4Init21897(ini: Sgp4Init) = {
 import ini._
...
assert(     no  ===     0.008782536 ); 
//    outputs  :
 assert(  isimp  ===               1); assert( method  ===               'd'); assert(  aycof  ===     0.001036737 ); 
...
// 21897
                                   // ------------------after initl  :---------------
def checkIntl22312(ini : Initl) {
 import ini._
  assert(   satn  ===           22312 );  assert(   ecco  ===     0.030872300 );  assert(  epoch  === 20548.462359120 );  assert(  inclo  ===     1.084697696 ); 
 //   in/out : 
  assert(     no  ===     0.069645394 ); 
 //   outputs : 
    assert(   ainv  ===     0.957212627 ); assert(     ao  ===     1.044699967 ); assert(  con41  ===    -0.345228516 ); assert(  con42  ===    -0.091285806 ); assert(  cosio  ===     0.467180009 ); 
...
/*  assert(  einx   ===     0.000953099 ); */ assert(  eccsq  ===     0.000953099 ); assert(  omeosq ===     0.999046901 ); assert(   posq  ===     1.089318592 ); assert(     rp  ===     1.012447676 ); assert(  rteosq ===     0.999523337 ); 
  assert(  sinio  ===     0.884162224 ); assert(   gsto  ===     6.267076520 ); 
       ...
       // ------------------after sgp4init :-------------
def checkSgp4Init22312(ini: Sgp4Init) = {
 import ini._
...
assert(     no  ===     0.069645394 ); 
//    outputs  :
 assert(  isimp  ===               1);  assert(  aycof  ===     0.001036711 ); 
...
// # *** error: t:= 494.202867 *** code =   1
                                   // ------------------after initl  :---------------
def checkIntl22674(ini : Initl) {
 import ini._
  assert(   satn  ===           22674 );  assert(   ecco  ===     0.754171200 );  assert(  epoch  === 20630.559091070 );  assert(  inclo  ===     1.108345162 ); 
 //   in/out : 
  assert(     no  ===     0.008582333 ); 
 //   outputs : 
    assert(   ainv  ===     0.237037492 ); assert(     ao  ===     4.218741906 ); assert(  con41  ===    -0.402868886 ); assert(  con42  ===     0.004781476 ); assert(  cosio  ===     0.446143144 ); 
...
/*  assert(  einx   ===     0.568774199 ); */ assert(  eccsq  ===     0.568774199 ); assert(  omeosq ===     0.431225801 ); assert(   posq  ===     3.309599096 ); assert(     rp  ===     1.037088260 ); assert(  rteosq ===     0.656677852 ); 
  assert(  sinio  ===     0.894961617 ); assert(   gsto  ===     2.003968970 ); 
       ...
       // ------------------after sgp4init :-------------
def checkSgp4Init22674(ini: Sgp4Init) = {
 import ini._
...
assert(     no  ===     0.008582333 ); 
//    outputs  :
 assert(  isimp  ===               1); assert( method  ===               'd'); assert(  aycof  ===     0.001049129 ); 
...
// 22674
                                   // ------------------after initl  :---------------
def checkIntl23177(ini : Initl) {
 import ini._
  assert(   satn  ===           23177 );  assert(   ecco  ===     0.725849100 );  assert(  epoch  === 20629.457520520 );  assert(  inclo  ===     0.123038731 ); 
 //   in/out : 
  assert(     no  ===     0.009853789 ); 
 //   outputs : 
    assert(   ainv  ===     0.259905620 ); assert(     ao  ===     3.847550501 ); assert(  con41  ===     1.954813125 ); assert(  con42  ===    -3.924688542 ); assert(  cosio  ===     0.992440279 ); 
...
/*  assert(  einx   ===     0.526856916 ); */ assert(  eccsq  ===     0.526856916 ); assert(  omeosq ===     0.473143084 ); assert(   posq  ===     3.314008748 ); assert(     rp  ===     1.054809433 ); assert(  rteosq ===     0.687853970 ); 
  assert(  sinio  ===     0.122728528 ); assert(   gsto  ===     1.346832291 ); 
       ...
       // ------------------after sgp4init :-------------
def checkSgp4Init23177(ini: Sgp4Init) = {
 import ini._
...
assert(     no  ===     0.009853789 ); 
//    outputs  :
 assert(  isimp  ===               1); assert( method  ===               'd'); assert(  aycof  ===     0.000143447 ); 
...
// 23177
                                   // ------------------after initl  :---------------
def checkIntl23333(ini : Initl) {
 import ini._
  assert(   satn  ===           23333 );  assert(   ecco  ===     0.972829800 );  assert(  epoch  === 16376.499999990 );  assert(  inclo  ===     0.501764707 ); 
 //   in/out : 
  assert(     no  ===     0.000318918 ); 
 //   outputs : 
    assert(   ainv  ===     0.026395664 ); assert(     ao  ===    37.885010518 ); assert(  con41  ===     1.305993572 ); assert(  con42  ===    -2.843322620 ); assert(  cosio  ===     0.876735150 ); 
...
/*  assert(  einx   ===     0.946397820 ); */ assert(  eccsq  ===     0.946397820 ); assert(  omeosq ===     0.053602180 ); assert(   posq  ===     4.123820315 ); assert(     rp  ===     1.029343313 ); assert(  rteosq ===     0.231521447 ); 
  assert(  sinio  ===     0.480973467 ); assert(   gsto  ===     3.849219569 ); 
       ...
       // ------------------after sgp4init :-------------
def checkSgp4Init23333(ini: Sgp4Init) = {
 import ini._
...
assert(     no  ===     0.000318918 ); 
//    outputs  :
 assert(  isimp  ===               1); assert( method  ===               'd'); assert(  aycof  ===     0.000590358 ); 
...
// 23333
                                   // ------------------after initl  :---------------
def checkIntl23599(ini : Initl) {
 import ini._
  assert(   satn  ===           23599 );  assert(   ecco  ===     0.578202200 );  assert(  epoch  === 20625.765354630 );  assert(  inclo  ===     0.120998441 ); 
 //   in/out : 
  assert(     no  ===     0.019529197 ); 
 //   outputs : 
    assert(   ainv  ===     0.410081086 ); assert(     ao  ===     2.438542120 ); assert(  con41  ===     1.956292062 ); assert(  con42  ===    -3.927153436 ); assert(  cosio  ===     0.992688615 ); 
...
/*  assert(  einx   ===     0.334317784 ); */ assert(  eccsq  ===     0.334317784 ); assert(  omeosq ===     0.665682216 ); assert(   posq  ===     2.635083806 ); assert(     rp  ===     1.028571701 ); assert(  rteosq ===     0.815893508 ); 
  assert(  sinio  ===     0.120703408 ); assert(   gsto  ===     3.217495488 ); 
       ...
       // ------------------after sgp4init :-------------
def checkSgp4Init23599(ini: Sgp4Init) = {
 import ini._
...
assert(     no  ===     0.019529197 ); 
//    outputs  :
 assert(  isimp  ===               1); assert( method  ===               'd'); assert(  aycof  ===     0.000141587 ); 
...
// 23599
                                   // ------------------after initl  :---------------
def checkIntl24208(ini : Initl) {
 import ini._
  assert(   satn  ===           24208 );  assert(   ecco  ===     0.002664000 );  assert(  epoch  === 20631.040617400 );  assert(  inclo  ===     0.067258008 ); 
 //   in/out : 
  assert(     no  ===     0.004397109 ); 
 //   outputs : 
    assert(   ainv  ===     0.151771988 ); assert(     ao  ===     6.588831124 ); assert(  con41  ===     1.986449532 ); assert(  con42  ===    -3.977415887 ); assert(  cosio  ===     0.997739033 ); 
...
/*  assert(  einx   ===     0.000007097 ); */ assert(  eccsq  ===     0.000007097 ); assert(  omeosq ===     0.999992903 ); assert(   posq  ===    43.412079396 ); assert(     rp  ===     6.571278478 ); assert(  rteosq ===     0.999996452 ); 
  assert(  sinio  ===     0.067207311 ); assert(   gsto  ===     5.037771726 ); 
       ...
       // ------------------after sgp4init :-------------
def checkSgp4Init24208(ini: Sgp4Init) = {
 import ini._
...
assert(     no  ===     0.004397109 ); 
//    outputs  :
 assert(  isimp  ===               1); assert( method  ===               'd'); assert(  aycof  ===     0.000079039 ); 
...
// 24208
                                   // ------------------after initl  :---------------
def checkIntl25954(ini : Initl) {
 import ini._
  assert(   satn  ===           25954 );  assert(   ecco  ===     0.000176500 );  assert(  epoch  === 19762.680572850 );  assert(  inclo  ===     0.000006981 ); 
 //   in/out : 
  assert(     no  ===     0.004374998 ); 
 //   outputs : 
    assert(   ainv  ===     0.151262768 ); assert(     ao  ===     6.611012179 ); assert(  con41  ===     2.000000000 ); assert(  con42  ===    -4.000000000 ); assert(  cosio  ===     1.000000000 ); 
...
/*  assert(  einx   ===     0.000000031 ); */ assert(  eccsq  ===     0.000000031 ); assert(  omeosq ===     0.999999969 ); assert(   posq  ===    43.705479308 ); assert(     rp  ===     6.609845335 ); assert(  rteosq ===     0.999999984 ); 
  assert(  sinio  ===     0.000006981 ); assert(   gsto  ===     0.403698641 ); 
       ...
       // ------------------after sgp4init :-------------
def checkSgp4Init25954(ini: Sgp4Init) = {
 import ini._
...
assert(     no  ===     0.004374998 ); 
//    outputs  :
 assert(  isimp  ===               1); assert( method  ===               'd'); assert(  aycof  ===     0.000000373 ); 
...
// 25954
                                   // ------------------after initl  :---------------
def checkIntl26900(ini : Initl) {
 import ini._
  assert(   satn  ===           26900 );  assert(   ecco  ===     0.000331900 );  assert(  epoch  === 20560.745032470 );  assert(  inclo  ===     0.000286234 ); 
 //   in/out : 
  assert(     no  ===     0.004375109 ); 
 //   outputs : 
    assert(   ainv  ===     0.151265340 ); assert(     ao  ===     6.610899752 ); assert(  con41  ===     1.999999754 ); assert(  con42  ===    -3.999999590 ); assert(  cosio  ===     0.999999959 ); 
...
/*  assert(  einx   ===     0.000000110 ); */ assert(  eccsq  ===     0.000000110 ); assert(  omeosq ===     0.999999890 ); assert(   posq  ===    43.703985905 ); assert(     rp  ===     6.608705595 ); assert(  rteosq ===     0.999999945 ); 
  assert(  sinio  ===     0.000286234 ); assert(   gsto  ===     1.971276525 ); 
       ...
       // ------------------after sgp4init :-------------
def checkSgp4Init26900(ini: Sgp4Init) = {
 import ini._
...
assert(     no  ===     0.004375109 ); 
//    outputs  :
 assert(  isimp  ===               1); assert( method  ===               'd'); assert(  aycof  ===     0.000000753 ); 
...
// 26900
                                   // ------------------after initl  :---------------
def checkIntl26975(ini : Initl) {
 import ini._
  assert(   satn  ===           26975 );  assert(   ecco  ===     0.560287700 );  assert(  epoch  === 20628.858188710 );  assert(  inclo  ===     1.195051373 ); 
 //   in/out : 
  assert(     no  ===     0.008973959 ); 
 //   outputs : 
    assert(   ainv  ===     0.244194689 ); assert(     ao  ===     4.095093165 ); assert(  con41  ===    -0.596008718 ); assert(  con42  ===     0.326681197 ); assert(  cosio  ===     0.366965612 ); 
...
/*  assert(  einx   ===     0.313922307 ); */ assert(  eccsq  ===     0.313922307 ); assert(  omeosq ===     0.686077693 ); assert(   posq  ===     7.893582846 ); assert(     rp  ===     1.800662834 ); assert(  rteosq ===     0.828298070 ); 
  assert(  sinio  ===     0.930234508 ); assert(   gsto  ===     3.853994597 ); 
       ...
       // ------------------after sgp4init :-------------
def checkSgp4Init26975(ini: Sgp4Init) = {
 import ini._
...
assert(     no  ===     0.008973959 ); 
//    outputs  :
 assert(  isimp  ===               1); assert( method  ===               'd'); assert(  aycof  ===     0.001090834 ); 
...
// 28057
                                   // ------------------after initl  :---------------
def checkIntl28129(ini : Initl) {
 import ini._
  assert(   satn  ===           28129 );  assert(   ecco  ===     0.004850600 );  assert(  epoch  === 20629.570711360 );  assert(  inclo  ===     0.955215209 ); 
 //   in/out : 
  assert(     no  ===     0.008751202 ); 
 //   outputs : 
    assert(   ainv  ===     0.240136739 ); assert(     ao  ===     4.164294079 ); assert(  con41  ===     0.000286839 ); assert(  con42  ===    -0.667144731 ); assert(  cosio  ===     0.577433066 ); 
...
/*  assert(  einx   ===     0.000023528 ); */ assert(  eccsq  ===     0.000023528 ); assert(  omeosq ===     0.999976472 ); assert(   posq  ===    17.340529165 ); assert(     rp  ===     4.144094755 ); assert(  rteosq ===     0.999988236 ); 
  assert(  sinio  ===     0.816438028 ); assert(   gsto  ===     2.059978512 ); 
       ...
       // ------------------after sgp4init :-------------
def checkSgp4Init28129(ini: Sgp4Init) = {
 import ini._
...
assert(     no  ===     0.008751202 ); 
//    outputs  :
 assert(  isimp  ===               1); assert( method  ===               'd'); assert(  aycof  ===     0.000957278 ); 
...
// 28129
                                   // ------------------after initl  :---------------
def checkIntl28350(ini : Initl) {
 import ini._
  assert(   satn  ===           28350 );  assert(   ecco  ===     0.002487000 );  assert(  epoch  === 20621.217886660 );  assert(  inclo  ===     1.134423871 ); 
 //   in/out : 
  assert(     no  ===     0.071927220 ); 
 //   outputs : 
    assert(   ainv  ===     0.978007836 ); assert(     ao  ===     1.022486695 ); assert(  con41  ===    -0.464089158 ); assert(  con42  ===     0.106815264 ); assert(  cosio  ===     0.422654643 ); 
...
/*  assert(  einx   ===     0.000006185 ); */ assert(  eccsq  ===     0.000006185 ); assert(  omeosq ===     0.999993815 ); assert(   posq  ===     1.045466108 ); assert(     rp  ===     1.019943771 ); assert(  rteosq ===     0.999996907 ); 
  assert(  sinio  ===     0.906290821 ); assert(   gsto  ===     5.982608944 ); 
       ...
       // ------------------after sgp4init :-------------
def checkSgp4Init28350(ini: Sgp4Init) = {
 import ini._
...
assert(     no  ===     0.071927220 ); 
//    outputs  :
 assert(  isimp  ===               1);  assert(  aycof  ===     0.001062658 ); 
...
// # *** error: t:= 1560.000000 *** code =   1
                                   // ------------------after initl  :---------------
def checkIntl28623(ini : Initl) {
 import ini._
  assert(   satn  ===           28623 );  assert(   ecco  ===     0.624905300 );  assert(  epoch  === 20631.810791840 );  assert(  inclo  ===     0.497767903 ); 
 //   in/out : 
  assert(     no  ===     0.016552797 ); 
 //   outputs : 
    assert(   ainv  ===     0.367277578 ); assert(     ao  ===     2.722736317 ); assert(  con41  ===     1.316080100 ); assert(  con42  ===    -2.860133500 ); assert(  cosio  ===     0.878650499 ); 
...
/*  assert(  einx   ===     0.390506634 ); */ assert(  eccsq  ===     0.390506634 ); assert(  omeosq ===     0.609493366 ); assert(   posq  ===     2.753906139 ); assert(     rp  ===     1.021283962 ); assert(  rteosq ===     0.780700561 ); 
  assert(  sinio  ===     0.477465496 ); assert(   gsto  ===     3.606984295 ); 
       ...
       // ------------------after sgp4init :-------------
def checkSgp4Init28623(ini: Sgp4Init) = {
 import ini._
...
assert(     no  ===     0.016552797 ); 
//    outputs  :
 assert(  isimp  ===               1); assert( method  ===               'd'); assert(  aycof  ===     0.000560155 ); 
...
// 28623
                                   // ------------------after initl  :---------------
def checkIntl28626(ini : Initl) {
 import ini._
  assert(   satn  ===           28626 );  assert(   ecco  ===     0.000033500 );  assert(  epoch  === 20630.466833970 );  assert(  inclo  ===     0.000033161 ); 
 //   in/out : 
  assert(     no  ===     0.004374949 ); 
 //   outputs : 
    assert(   ainv  ===     0.151261648 ); assert(     ao  ===     6.611061098 ); assert(  con41  ===     1.999999997 ); assert(  con42  ===    -3.999999995 ); assert(  cosio  ===     0.999999999 ); 
...
/*  assert(  einx   ===     0.000000001 ); */ assert(  eccsq  ===     0.000000001 ); assert(  omeosq ===     0.999999999 ); assert(   posq  ===    43.706128744 ); assert(     rp  ===     6.610839627 ); assert(  rteosq ===     0.999999999 ); 
  assert(  sinio  ===     0.000033161 ); assert(   gsto  ===     1.422713434 ); 
       ...
       // ------------------after sgp4init :-------------
def checkSgp4Init28626(ini: Sgp4Init) = {
 import ini._
...
assert(     no  ===     0.004374949 ); 
//    outputs  :
 assert(  isimp  ===               1); assert( method  ===               'd'); assert(  aycof  ===     0.000000169 ); 
...
// 28626
                                   // ------------------after initl  :---------------
def checkIntl28872(ini : Initl) {
 import ini._
  assert(   satn  ===           28872 );  assert(   ecco  ===     0.030395500 );  assert(  epoch  === 20422.020126610 );  assert(  inclo  ===     1.683781961 ); 
 //   in/out : 
  assert(     no  ===     0.071874628 ); 
 //   outputs : 
    assert(   ainv  ===     0.977531046 ); assert(     ao  ===     1.022985412 ); assert(  con41  ===    -0.961865427 ); assert(  con42  ===     0.936442378 ); assert(  cosio  ===    -0.112745397 ); 
...
/*  assert(  einx   ===     0.000923886 ); */ assert(  eccsq  ===     0.000923886 ); assert(  omeosq ===     0.999076114 ); assert(   posq  ===     1.044566354 ); assert(     rp  ===     0.991891259 ); assert(  rteosq ===     0.999537950 ); 
  assert(  sinio  ===     0.993623911 ); assert(   gsto  ===     1.313288306 ); 
       ...
       // ------------------after sgp4init :-------------
def checkSgp4Init28872(ini: Sgp4Init) = {
 import ini._
...
assert(     no  ===     0.071874628 ); 
//    outputs  :
 assert(  isimp  ===               1);  assert(  aycof  ===     0.001165059 ); 
...
// 28872
                                   // ------------------after initl  :---------------
def checkIntl29141(ini : Initl) {
 import ini._
  assert(   satn  ===           29141 );  assert(   ecco  ===     0.001584800 );  assert(  epoch  === 20624.267838450 );  assert(  inclo  ===     1.438653958 ); 
 //   in/out : 
  assert(     no  ===     0.069571632 ); 
 //   outputs : 
    assert(   ainv  ===     0.956536647 ); assert(     ao  ===     1.045438252 ); assert(  con41  ===    -0.947919382 ); assert(  con42  ===     0.913198970 ); assert(  cosio  ===     0.131758134 ); 
...
/*  assert(  einx   ===     0.000002512 ); */ assert(  eccsq  ===     0.000002512 ); assert(  omeosq ===     0.999997488 ); assert(   posq  ===     1.092935649 ); assert(     rp  ===     1.043781442 ); assert(  rteosq ===     0.999998744 ); 
  assert(  sinio  ===     0.991281894 ); assert(   gsto  ===     0.065747677 ); 
       ...
       // ------------------after sgp4init :-------------
def checkSgp4Init29141(ini: Sgp4Init) = {
 import ini._
...
assert(     no  ===     0.069571632 ); 
//    outputs  :
 assert(  isimp  ===               0);  assert(  aycof  ===     0.001162313 ); 
...
//# *** error: t:= 440.000000 *** code =   6
                                   // ------------------after initl  :---------------
def checkIntl29238(ini : Initl) {
 import ini._
  assert(   satn  ===           29238 );  assert(   ecco  ===     0.020257900 );  assert(  epoch  === 20631.287320100 );  assert(  inclo  ===     0.899883036 ); 
 //   in/out : 
  assert(     no  ===     0.068663016 ); 
 //   outputs : 
    assert(   ainv  ===     0.948190069 ); assert(     ao  ===     1.054640871 ); assert(  con41  ===     0.159538584 ); assert(  con42  ===    -0.932564306 ); assert(  cosio  ===     0.621701585 ); 
...
/*  assert(  einx   ===     0.000410383 ); */ assert(  eccsq  ===     0.000410383 ); assert(  omeosq ===     0.999589617 ); assert(   posq  ===     1.111354644 ); assert(     rp  ===     1.033276062 ); assert(  rteosq ===     0.999794788 ); 
  assert(  sinio  ===     0.783254198 ); assert(   gsto  ===     0.308909174 ); 
       ...
       // ------------------after sgp4init :-------------
def checkSgp4Init29238(ini: Sgp4Init) = {
 import ini._
...
assert(     no  ===     0.068663016 ); 
//    outputs  :
 assert(  isimp  ===               1);  assert(  aycof  ===     0.000918393 ); 
...
// 29238
                                   // ------------------after initl  :---------------
def checkIntl88888(ini : Initl) {
 import ini._
  assert(   satn  ===           88888 );  assert(   ecco  ===     0.008673100 );  assert(  epoch  === 11232.987084650 );  assert(  inclo  ===     1.271358914 ); 
 //   in/out : 
  assert(     no  ===     0.070106156 ); 
 //   outputs : 
    assert(   ainv  ===     0.961429817 ); assert(     ao  ===     1.040117523 ); assert(  con41  ===    -0.738955620 ); assert(  con42  ===     0.564926033 ); assert(  cosio  ===     0.294982700 ); 
...
/*  assert(  einx   ===     0.000075223 ); */ assert(  eccsq  ===     0.000075223 ); assert(  omeosq ===     0.999924777 ); assert(   posq  ===     1.081681709 ); assert(     rp  ===     1.031096480 ); assert(  rteosq ===     0.999962388 ); 
  assert(  sinio  ===     0.955502594 ); assert(   gsto  ===     0.108290142 ); 
       ...
       // ------------------after sgp4init :-------------
def checkSgp4Init88888(ini: Sgp4Init) = {
 import ini._
...
assert(     no  ===     0.070106156 ); 
//    outputs  :
 assert(  isimp  ===               1);  assert(  aycof  ===     0.001120360 ); 
